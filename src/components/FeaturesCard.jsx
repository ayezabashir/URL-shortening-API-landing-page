const FeaturesCard = ({icon, title,description}) => {
  return (
    <div className='flex flex-col justify-between items-center border border-blue py-10 px-5 rounded-xl min-h-70'>
        <div className="border border-blue h-20 w-20 flex justify-center items-center group bg-blue rounded-full">
