                        ...
                        t_features.map((feature, index) => {
                            ...
                            return <tr key={index} >
                                ...
                                <td className={`text-sm text-purple py-4 font-light ${isLast ? "border-0" : "border-b border-gray"}`}>
                                    {
                                        feature.free === "unincluded" ? <img src={iconMap.unincluded} alt="unincluded" className="w-5" /> : feature.free
                                    }
                                </td>
                                <td className={`text-sm text-purple py-4 font-light ${isLast ? "border-0" : "border-b border-gray"}`}>
                                    {
                                        feature.pro_Monthly === "unincluded" ? <img src={iconMap.unincluded} alt="unincluded" className="w-5" /> : feature.pro_Monthly
                                    }
                                </td>
                                <td className={`text-sm text-purple py-4 font-light ${isLast ? "border-0" : "border-b border-gray"}`}>
                                    {
                                        feature.premium_Monthly === "unincluded" ? <img src={iconMap.unincluded} alt="unincluded" className="w-5" /> : feature.premium_Monthly
                                    }
                                </td>
                                <td className={`text-sm text-purple py-4 font-light ${isLast ? "border-0" : "border-b border-gray"}`}>
                                    {
                                        feature.pro_Yearly === "unincluded" ? <img src={iconMap.unincluded} alt="unincluded" className="w-5" /> : feature.pro_Yearly
                                    }
                                </td>
                                <td className={`text-sm text-purple py-4 font-light ${isLast ? "border-0" : "border-b border-gray"}`}>
                                    {
                                        feature.premium_Yearly === "unincluded" ? <img src={iconMap.unincluded} alt="unincluded" className="w-5" /> : feature.premium_Yearly
                                    }
                                </td>
                            </tr>
                        })
